...
class Application_Form_EditOeuvre extends Zend_Form {

    protected $_color;

    public function __construct($options = null) {
        $config = new Zend_Config_Ini(CONFIGS_PATH . '/formEditOeuvre.ini', 'editOeuvre');
        ...
        $this->setDecorators(array(
            array('ViewScript', array(
                'viewScript' => '_formEditOeuvre.phtml',
                'mode' => 'edit',
            ))
            )
        );
