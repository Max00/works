...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 06 Octobre 2015 à 13:04
...
--
CREATE DATABASE IF NOT EXISTS `works` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `works`;
...
DROP TABLE IF EXISTS `additional_workers`;
...
--
-- Vider la table avant d'insérer `additional_workers`
--

TRUNCATE TABLE `additional_workers`;
--
-- Contenu de la table `additional_workers`
--

INSERT INTO `additional_workers` (`id`, `label`, `work_id`) VALUES
(16, 'Autre intervenant', 16),
(17, 'Greg', 16),
(19, 'Jean Bergeron', 5);
...
--
-- Vider la table avant d'insérer `oeuvres`
--

TRUNCATE TABLE `oeuvres`;
--
...
(1, 'Maxime', 'Kieffer', 'mk@bwets.net', '61b8eeb6ca9ec34403d7a7f89b44db7601ecec19', NULL, 2),
(2, 'Grégory', 'Someil', 'worker@ventdesforets.org', 'ee5482bde8c2812d3f39f5b0cf0ecfd17f27dd29', NULL, 1),
(13, 'User', 'User', 'user@example.com', '9d4e1e23bd5b727046a9e3b4b7db57bd8d6ee684', NULL, 2);
...
--
-- Vider la table avant d'insérer `works`
--
...
(1, 'Écorcer arbre Damien Roubaix', '', 'Pioche, marteau', '2015-03-11', '2015-10-05', NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL, 2, NULL, '2015-10-06', 0),
(2, 'Restauration eau bâtiment Ehren', '', NULL, '2015-03-11', '2015-09-30', NULL, '5.440355502658463', '48.957613489686196', NULL, 3, NULL, NULL, NULL, 3, NULL, NULL, '2015-10-06', 0),
(3, 'Repeindre', '', NULL, '2015-03-11', '2015-03-11', '', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, 3, NULL, '2015-10-05', 3),
(5, 'Nettoyer et peindre plaques anti-rouille + soudure', 'Soudure: RENNESSON \r\nManitout: COHEN', NULL, '2015-03-11', '2015-10-05', NULL, '5.416330529106972', '48.937218508620695', NULL, 2, NULL, NULL, NULL, NULL, NULL, 1, '2015-10-06', 0),
(6, 'Réparer les attaches des deux lettres et les repositionner', '', 'Choisir une sangle de couleur discrète (pas bleue ni rouge)', '2015-03-11', '2015-10-06', NULL, '5.445097857157407', '48.937511970014256', NULL, 1, NULL, NULL, NULL, 1, NULL, NULL, '2015-10-05', 0),
(7, 'Changer support contre-plaqué / rapporter une lettre au bureau pour évaluer la restauration', '', 'Sangle et échelle', '2015-03-11', '2015-09-30', NULL, '5.3985277777778', '48.928222222222', NULL, 2, NULL, NULL, NULL, NULL, 3, NULL, '2015-10-06', 0),
(16, 'Autre travail près de 8215', 'Description du travail', 'Outils à emporter', '2015-09-25', '2015-09-30', 'Un peu plus loin qu''Utopia', '5.437394343906021', '48.951357370073346', NULL, 3, 1, NULL, NULL, 6, 4, NULL, '2015-10-06', 0),
(17, 'Test', '', NULL, '2015-09-30', '2015-10-06', NULL, '5.439068042331314', '48.95347101175143', NULL, 3, NULL, NULL, NULL, NULL, 5, NULL, '2015-10-06', 0);
...
--
-- Vider la table avant d'insérer `works_types`
--

TRUNCATE TABLE `works_types`;
--
...
--
DROP VIEW IF EXISTS `works_with_coords`;
...
DROP TABLE IF EXISTS `works_workers`;
...
--
-- Vider la table avant d'insérer `works_workers`
--

TRUNCATE TABLE `works_workers`;
--
-- Contenu de la table `works_workers`
--

INSERT INTO `works_workers` (`work_id`, `user_id`, `date_added`, `date_done`) VALUES
(1, 2, '2015-10-06 11:14:50', NULL),
(5, 2, '2015-10-06 11:17:11', NULL),
(6, 2, '2015-10-06 11:17:20', NULL);
